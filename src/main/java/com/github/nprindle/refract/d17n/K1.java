 ...
 * in {@A2<Identity.Mu, A>}. Once a symbol is fully-applied (it carries as many type arguments as
 * the underlying concrete type), it may be run into the concrete type using {@code unbox}.
 */
public interface K1 {}
