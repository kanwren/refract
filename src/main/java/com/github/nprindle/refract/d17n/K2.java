 ...
 * in {@A2<Either.Mu2, A, B>}. Once a symbol is fully-applied (it carries as many type arguments as
 * the underlying concrete type), it may be run into the concrete type using {@code unbox2}.
 */
public interface K2 {}
