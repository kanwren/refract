...
public final class Void {
    ...
    /**
     * Since {@code Void} is uninhabited, any {@code Functor} containing it
     * holds no values; since the type parameter is phantom, {@code vacuous} can
     * be used to transform it arbitrarily.
     */
