...
public final class Pair<A, B> implements A1<Pair.Mu<A>, B>, A2<Pair.Mu2, A, B> {
    ...
    public <C, D> Pair<C, D> mapBoth(final Function<? super A, ? extends C> f, final Function<? super B, ? extends D> g) {
    ...
    public static final class Instances {
        ...
        private static final class FunctorI<K> implements Functor<Pair.Mu<K>> {
            @Override
            public <A, B> A1<Pair.Mu<K>, B> map(final Function<? super A, ? extends B> f, final A1<Pair.Mu<K>, A> x) {
        ...
        private static enum BifunctorI implements Bifunctor<Pair.Mu2> {
            ...
            @Override
            public <A, B, C, D> A2<Pair.Mu2, C, D> bimap(final Function<? super A, ? extends C> f, final Function<? super B, ? extends D> g, final A2<Pair.Mu2, A, B> x) {
